...
const paymentConfig = {
  ...
  server: {
    url: window.location.hostname === 'localhost' || window.location.hostname === '127.0.0.1'
      ? 'http://localhost:3000' // 本地开发服务器地址
      : 'https://zonya.work', // 生产服务器地址
  ...
  // 支付宝配置
  alipay: {
    appId: '2021006143648470', // 支付宝应用ID
...
-----END PUBLIC KEY-----`, // 支付宝公钥（从支付宝开放平台获取）
  ...
  // 银联在线支付配置（测试环境）
  unionpay: {
    merId: '777290058110097', // 银联测试商户号
    gatewayUrl: 'https://gateway.test.95516.com', // 银联测试网关
    // 正式网关: https://gateway.95516.com
    notifyUrl: 'https://zonya.work/api/unionpay/notify', // 银联回调地址
    frontUrl: 'https://zonya.work/payment.html?status=unionpay_return' // 前端返回地址
  },
