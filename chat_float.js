...
function initChatFloat() {
  ...
  const chatFloatHTML = `
    ...
    <div class="chat-float" style="display: block; position: fixed; bottom: 30px; right: 30px; z-index: 9999;">
      ...
      <div class="chat-panel" id="chatPanel" style="display: none; position: absolute; bottom: 70px; right: 0; width: 350px; height: 500px; background-color: white; border-radius: 8px; box-shadow: 0 4px 20px rgba(0, 0, 0, 0.15); flex-direction: column; overflow: hidden;">
